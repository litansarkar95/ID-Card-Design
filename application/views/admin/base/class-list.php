...
?>
 <div class="col-md-4 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">ক্লাস এডিট  করুন</h4>
             
                    <form class="forms-sample"  action="<?php echo base_url(); ?>admin/base/classes/update" method="post" enctype="multipart/form-data">
                    <input type="hidden" class="form-control" id="id" value="<?php echo $val->id; ?>" name="id"   />
                    <div class="form-group">
                        <label for="eorganization_name">প্রতিষ্ঠানের নাম<code>*</code></label>
                      ...
                      <!-- END FORM -->
                    <div class="form-group">
                        <label for="eclass_id">ক্লাসের নাম<code>*</code></label>
...
<?php
            ...
            ?>
              <div class="col-md-4 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                  <h4 class="card-title">নতুন ক্লাস তৈরি করুন</h4>
             
                    <form class="forms-sample"  action="<?php echo base_url(); ?>admin/base/classes" method="post" enctype="multipart/form-data">
              ...
              <div class="col-md-8 grid-margin ">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">ক্লাস তালিকা</h4>
...
?>
                          ...
                          <td>
                              <a  class="btn btn-add btn-sm badge-primary text-white"  href="<?php echo base_url()."admin/base/classes?edit={$pdt->id}";?>"><i class="fa fa-pencil"></i></a>
                              <a  class="btn btn-add btn-sm badge-danger text-white"  href="<?php echo base_url()."admin/base/classes/delete/{$pdt->id}";?>"><i class="fa fa-trash-o"></i></a>
                            </td>
                          </tr>
