...
?>
 <div class="col-md-4 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">  সেশন এডিট করুন</h4>
                    ...
                    <label for="company_name">কোম্পানির নাম<code>*</code></label>
                      ...
                      <!-- END FORM -->
                    <div class="form-group">
                    <label for="class_id">সেশন নাম<code>*</code></label>
...
<?php
            ...
            ?>
              <div class="col-md-4 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">নতুন সেশন তৈরি করুন</h4>
              ...
              <div class="col-md-8 grid-margin ">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">সেশন  লিস্ট</h4>
