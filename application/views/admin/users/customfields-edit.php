                ...
                <div class="card">
                  <div class="card-body">
                   ...
                   <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="terms_conditions_name" value="<?php echo $val->terms_conditions_name; ?>" name="terms_conditions_name"   />
                    ...
                    <div class="form-group">
                        ...
                        <textarea type="text" class="form-control" id="terms_conditions"  name="terms_conditions"   ><?php echo $val->terms_conditions; ?></textarea>
