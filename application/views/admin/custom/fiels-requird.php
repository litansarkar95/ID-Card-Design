              ...
              <div class="col-md-8 offset-md-2 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="forms-sample"  action="<?php echo base_url()."admin/card/custom/design/1"; ?>" method="post" enctype="multipart/form-data">
                      <div class="form-group">
                        <label for="fields_code">Fields Code<code>*</code></label>
                        <select type="text" class="form-control" id="fields_code" value="<?php echo set_value('fields_code'); ?>" name="fields_code"   >
