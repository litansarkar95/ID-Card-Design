        ...
        ?>
			...
			<div class="front_part card-design-break">
				...
				<section class="body_part">
					<h3 class="title"><?php 	if($name_en == 1){ echo $qr->name_en; }else if($name_bn == 1){
                                    echo $qr->name_bn;
							} ?></h3>
					 <!--- Start Index No-->
