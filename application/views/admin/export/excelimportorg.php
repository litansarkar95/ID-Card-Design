...
<div class="container-fluid page-body-wrapper">
          ...
          <div class="content-wrapper">
            ...
            <div class="col-md-4 grid-margin stretch-card ">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Export Users Information</h4>
                    <?php echo form_open_multipart('admin/export/excelimportorg/export'); ?>
        ...
        $(document).ready(function() {
            $('#eorganization_name').change(function() {
                ...
                if (category_id != '') {
                    $.ajax({
                        url: "<?php echo site_url('admin/export/excelimportorg/fetch_classes'); ?>",
                        method: "POST",
                ...
                if (category_id != '') {
                    $.ajax({
                        url: "<?php echo site_url('admin/export/excelimportorg/fetch_sections'); ?>",
                        method: "POST",
                        data: { category_id: category_id },
                        dataType: "json",
                        success: function(data) {
                ...
                if (category_id != '') {
                    $.ajax({
                        url: "<?php echo site_url('admin/export/excelimportorg/fetch_session'); ?>",
                        method: "POST",
                        data: { category_id: category_id },
                        dataType: "json",
                        success: function(data) {
            ...
            if (category_id != '') {
                    $.ajax({
                        url: "<?php echo site_url('admin/export/excelimportorg/fetch_org_form'); ?>",
                        method: "POST",
                        data: { category_id: category_id },
                        dataType: "json",
                        success: function(data) {
