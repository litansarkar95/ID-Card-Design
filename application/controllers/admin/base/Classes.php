...
class Classes extends CI_Controller {
	...
	public function index()
	{
        ...
        if ($this->common_model->save_data("classes", $data)) {
          ...
          redirect(base_url() . "admin/base/classes", "refresh");
        }
        ...
        $data['allPdt'] = $this->main_model->AgentOrgClassesList("classes");
        $data['content'] = $this->load->view("admin/base/class-list", $data, TRUE);
    ...
    public function update(){
        ...
        $selPdt=$this->common_model->view_data("classes",array("id"=>$id),"id","desc");
        ...
        $data = array(
            ...
            if ($this->common_model->update_data("classes", $data,array("id"=>$id))) {
    ...
    public function delete($id) {
        $dt = $this->common_model->view_data("classes", array("id" => $id), "id", "asc");
