...
class Sessions extends CI_Controller {
	...
	public function index()
	{
        ...
        $this->form_validation->set_rules("class_id", "Sessions Name", "required");
        ...
        if ($this->common_model->save_data("sessions", $data)) {
          ...
          redirect(base_url() . "admin/base/sessions", "refresh");
        }
        ...
        $data['allPdt'] = $this->main_model->AgentOrgClassesList("sessions");
        $data['content'] = $this->load->view("admin/base/sessions", $data, TRUE);
    ...
    public function update(){
        ...
        $selPdt=$this->common_model->view_data("sessions",array("id"=>$id),"id","desc");
        ...
        $data = array(
            ...
            if ($this->common_model->update_data("sessions", $data,array("id"=>$id))) {
