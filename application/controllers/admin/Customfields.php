...
class Customfields extends CI_Controller {
	...
	public function index()
	{
        ...
        if ($this->form_validation->run() == NULL) {
          ...
          $organization_id = $this->session->userdata('loggedin_userid');
          ...
          $data = array(   
              ...
              "terms_conditions_name"             => $this->common_model->xss_clean($this->input->post("terms_conditions_name")),
              "terms_conditions"                  => $this->common_model->xss_clean($this->input->post("terms_conditions")),
              ...
              "is_father_mobile_no"               => $this->common_model->xss_clean($this->input->post("is_father_mobile_no")),
              ...
              "is_mother_mobile_no"               => $this->common_model->xss_clean($this->input->post("is_mother_mobile_no")),
